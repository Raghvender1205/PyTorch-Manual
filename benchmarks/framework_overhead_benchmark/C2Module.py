...
class C2SimpleNet(object):
    r"""
    This module constructs a network with 'op_name'. The net consists a series
    of such operator.
    
    It initializes the workspace with input blob equal to the number of parameters needed for the op.
