...
for op in unary_ops:
    ...
    # Warmup 
    warmup_iters = 10 # Tweak with this
...
def test_batch_norm():
    ...
    for n, c, h, w in batch_norm_shapes:
        ...
        # Benchmark
        bench_iters = 100
        teager = timeit.timeit(
            stmt="op(x, y, z)", globals=locals(), number=bench_iters)
        tjit = timeit.timeit(stmt="traced(x, y, z)",
                             globals=locals(), number=bench_iters)
